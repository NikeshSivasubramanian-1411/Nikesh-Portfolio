    ...
    <section ref={sectionRef} className="w-full relative select-none my-40">
      ...
      >
        <p className="opacity-40 text-6xl sm:text-7xl font-semibold whitespace-nowrap ui-left transform-gpu">
          {Array(5)
            .fill(
              " Cybersecurity • Full Stack Development • React.js • Node.js • MongoDB • API Integration • HTML • CSS • JavaScript • Tailwind CSS • Python "
            )
        ...
        <p className="mt-6 md:mt-8 opacity-40 text-6xl sm:text-7xl font-semibold whitespace-nowrap ui-right transform-gpu">
          {Array(5)
            .fill(
              "  • Ethical Hacking • Networking • Vulnerability Assessment • Secure Coding Practices • Git • GitHub • Figma • Canva • Problem Solving • Team Collaboration "
            )
            .reduce((str, el) => str.concat(el), "")}{" "}
        </p>
      </div>
